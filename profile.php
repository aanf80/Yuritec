...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-3">
            <img class="center-block img-responsive" src="img/Android.png">
            <br>
            <br>
    ...
    <footer>
        <div class="row">
            <div class="col-lg-12">
                <p class="text-center">REVISTA DE CIENCIAS DEL INSTITUTO TECNOLÓGICO DE TEPIC. AV. TECNOLÓGICO # 2595, COL. LAGOS DEL COUNTRY. TEPIC, NAYARIT. MÉXICO. C.P. 63175. TEL: (311) 211 94 00. COMUNICACION@ITTEPIC.EDU.MX</p>
            </div>
        </div>
    </footer>
